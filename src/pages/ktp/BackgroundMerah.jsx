...
export default function BackgroundMerah() {
  return (
    <div className='template-generator mx-auto padding-10mm bg-transparent grid place-items-center h-screen'>
      <BackArrow />
      <AnimatedPage>
        <div className='bg-ktp-red bg-contain bg-center mx-auto h-72 w-96 aspect-video relative xl:scale-175 lg:scale-175 md:scale-125 sm:scale-110 xs:scale-110' id='content'>
