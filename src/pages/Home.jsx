...
export default function Home() {
  return (
    <div id='mainHome'>
        <img className='absolute left-0 top-0 2xl:w-56 xl:w-56 md:w-56 sm:w-32 xs:w-32 z-50' src='media/home/sun.gif' />
        <AnimatedPage>
            ...
            <section className='container mx-auto grid grid-cols-1 2xl:block xl:block md:block sm:hidden xs:hidden'>
                <div className='flex 2xl:mt-16 xl:mt-16 md:mt-16 sm:mt-2 xs:mt-2 gap-6'>
                    <a href='/bg-biru' >
                        <img className='object-fit xl:max-w-full lg:max-w-full sm:max-w-xs xs:max-w-xs' src='media/home/ktpBiru.png' />
                    </a>
                    <a href='/bg-merah' >
                        <img className='object-fit xl:max-w-full lg:max-w-full sm:max-w-xs xs:max-w-xs' src='media/home/ktpMerah.png' />
                    </a>
                    <a href='/bg-sim' >
                        <img className='object-fit xl:max-w-full lg:max-w-full sm:max-w-xs xs:max-w-xs' src='media/home/simUmum.png' />
                    </a>
                </div>
            </section>
            <section className='grid grid-cols-1 2xl:hidden xl:hidden md:hidden sm:block xs:block'>
                <div className='flex 2xl:mt-16 xl:mt-16 md:mt-16 sm:mt-2 xs:mt-2 gap-6 mobileHome overflow-x-scroll'>
                    <a href='/bg-biru' >
                        <img className='ml-6 object-fit xl:max-w-full lg:max-w-full sm:max-w-xs xs:max-w-xs' src='media/home/ktpBiru.png' />
                    </a>
                    <a href='/bg-merah' >
                        <img className='object-fit xl:max-w-full lg:max-w-full sm:max-w-xs xs:max-w-xs' src='media/home/ktpMerah.png' />
                    </a>
                    <a href='/bg-sim' >
                        <img className='mr-6 object-fit xl:max-w-full lg:max-w-full sm:max-w-xs xs:max-w-xs' src='media/home/simUmum.png' />
                    </a>
                </div>
            </section>
            <section className='container mx-auto bg-white h-screen mb-24  mb-56'>
                <div className='grid place-items-center mt-12 rounded-3xl 2xl:pt-32 xl:pt-32 md:pt-32 sm:pt-24 xs:pt-24'>
                    <div className='flex flex-col items-center text-center space-y-12 relative'>
                        ...
                        <div className='grid 2xl:grid-cols-3 xl:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-2 gap-y-12 gap-x-12 z-50'>
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='font-base 2xl:text-2xl xl:text-2xl lg:text-2xl sm:text-md xs:text-md  text-rose-500 mt-2'>Realtime Editing</h3>
                            ...
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='font-base 2xl:text-2xl xl:text-2xl lg:text-2xl sm:text-md xs:text-md  text-rose-500 mt-2'>Export .pdf/jpg</h3>
                            ...
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='font-base 2xl:text-2xl xl:text-2xl lg:text-2xl sm:text-md xs:text-md  text-rose-500 mt-2'>Editing Mudah</h3>
                            ...
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='font-base 2xl:text-2xl xl:text-2xl lg:text-2xl sm:text-md xs:text-md  text-rose-500 mt-2'>Tidak Perlu Login</h3>
                            ...
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='font-base 2xl:text-2xl xl:text-2xl lg:text-2xl sm:text-md xs:text-md  text-rose-500 mt-2'>Gratis</h3>
                            ...
                            <div className='flex flex-col items-center'>
                                ...
                                <h3 className='font-base 2xl:text-2xl xl:text-2xl lg:text-2xl sm:text-md xs:text-md  text-rose-500 mt-2'>Open Source</h3>
